...
const imagesByArea: Record<string, [string, string, string, string]> = {
  "may-rang": ["/images/1.5KG.jpg", "/images/3KG_2.jpg", "/images/3KG_3.jpg", "/images/3KG.jpg"],
  "bep-cong-nghiep": ["/images/kitchen_4.jpg", "/images/kitchen_1.jpg", "/images/kitchen_3.jpg", "/images/kitchen_2.jpg"],
  "noi-that": ["/images/fur3.jpg", "/images/fur6.jpg", "/images/fur8.jpg", "/images/fur7.jpg"],
};
...
export function MachineDetails({ area, dict }: { area?: string; dict: Dictionary }) {
  const key = area && dict.machineDetails[area as keyof typeof dict.machineDetails] ? area : "may-rang";
  const c = dict.machineDetails[key as keyof typeof dict.machineDetails] ?? dict.machineDetails["may-rang"];
