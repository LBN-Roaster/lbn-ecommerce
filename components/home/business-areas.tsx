...
const areas = [
  {
    ...
    description: "Máy rang chuyên nghiệp 6–60kg với hệ thống điều khiển nhiệt độ chính xác, cho ra mẻ rang đồng đều, ổn định.",
  },
  {
    key: "bep-cong-nghiep",
    icon: (
    ...
    description: "Thiết kế và thi công hệ thống bếp công nghiệp cho nhà hàng, khách sạn, bếp ăn tập thể — đảm bảo an toàn và hiệu suất cao.",
  },
  {
    key: "noi-that",
    icon: (
    ...
    description: "Sản xuất nội thất kết hợp gỗ và thép theo yêu cầu — bền bỉ, thẩm mỹ cao, phù hợp cho văn phòng, nhà ở và thương mại.",
  },
];
          ...
          {areas.map((area) => {
            ...
            return (
              ...
              >
                ...
                <h3 className={`mb-2 text-lg font-semibold ${isActive ? "text-blue-700 dark:text-blue-300" : "text-black dark:text-white"}`}>
                  {area.title}
                </h3>
