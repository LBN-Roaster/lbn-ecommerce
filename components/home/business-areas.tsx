...
const areas = [
  {
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12a3 3 0 0 0 3-3V3M15 12a3 3 0 0 1-3-3" />
      </svg>
    ),
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {areas.map((area) => (
            <Link
              key={area.title}
              href={area.href}
              className="group rounded-2xl border border-neutral-200 p-8 transition hover:border-blue-600 hover:shadow-lg dark:border-neutral-800 dark:hover:border-blue-500"
            >
              <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50 text-blue-600 transition group-hover:bg-blue-600 group-hover:text-white dark:bg-blue-950 dark:text-blue-400">
                {area.icon}
              </div>
